...
const studyGroups = [
  {
    ...
    members: 15,
    image:
      "https://github.com/powwwy/Study-Hub/blob/main/images/dsa.jpg?raw=true",
  },
  {
    id: 2,
    ...
    members: 12,
    image:
      "https://github.com/powwwy/Study-Hub/blob/main/images/business-management.png?raw=true",
  },
  {
    id: 3,
    unitName: "Japanese I",
    ...
    members: 18,
    image:
      "https://github.com/powwwy/Study-Hub/blob/main/images/japanese-i.png?raw=true",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    members: 20,
    image:
      "https://images.unsplash.com/photo-1556742044-3c52d6e88c62?auto=format&fit=crop&w=800&q=60",
  },
];
...
function startTimer() {
  if (timerId) return; // Don't start again if already running
  timerId = setInterval(() => {
    if (timeLeft <= 0) {
...
// Show starting time on page load
updateDisplay();
